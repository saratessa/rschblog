...
DiagrammeR::grViz(
  "digraph G {
    VocabularyFall -> VocabularySpring;
    MathLanguageFall -> MathLanguageSpring;
    EF_Fall -> EF_Spring;
    VocabularyFall -> EF_Spring;
    MathLanguageFall -> EF_Spring;
    EF_Fall -> VocabularySpring;
    EF_Fall -> MathLanguageSpring;
  }"
)
```
