...
```{r}
# Descriptive Statistics
descr_stats <- descr(data_long, stats = c("mean", "sd", "min", "med", "max"))
print(descr_stats)

# Correlation Table
cor_matrix <- corr.test(data_long)
cor_table <- cor_matrix$r
p_values <- cor_matrix$p

# Display correlation table
kable(cor_table, digits = 2, caption = "Correlation Matrix")
```

```{r}
# Ensure factor conversion for plotting


# Demographic Statistics Bar Chart
